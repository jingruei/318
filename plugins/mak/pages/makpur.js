define(function() {
    angular.module('app').controller('ord.makPurSuggest',
            ...
            scope.action = {
                ...
                load: function() {
                    ...
                    scope.promise = utils.ajax({
                        method: 'POST',
                        url: "mak/makbah/makPurSuggest?page=" + scope.datapage.page + "&size=" + scope.datapage.size + "&sort=" + scope.datapage.sort,
