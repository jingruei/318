define(function() {
    angular.module('app').controller('bas.basdm.detail',
                ...
                del: function() {
                    dialog.confirm('确定删除当前数据?').then(function() {
                        scope.promise = utils.ajax({
                            method: 'DELETE',
                            url: "bas/basdm/" + scope.model.uid,
                            mockUrl: "plugins/data/basdm.detail.json"
                        }).then(function(res) {
                            toastr.info("数据删除成功!!!");
                            scope.uid = "";
                            scope.action.add();
                            scope.refreshtab("refreshbasdm", {});
