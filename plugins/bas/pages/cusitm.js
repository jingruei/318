define(function() {
    angular.module('app').controller('pur.cusitm',
        function($rootScope, $scope, $location, uiGridConstants, utils, path, settings,
            ...
            scope.action = {
                ...
                //     var node = {
                //         name: "",
                //         url: 'pur/cusitm.detail'
                //     }
                //     $scope.$emit('opencusdetail', node);
                // }
            }
            $scope.$on('refreshcusitm', function(event, message) {
                scope.action.load()
            });
            // scope.action.load();
        });
