define(function() {
    angular.module('app').controller('sale.cussale',
        function($rootScope, $scope, $location, uiGridConstants, utils, path, settings,
            ...
            scope.idprofita = "cussalea"
            scope.idprofitb = "cussaleb"
                ...
                showimage: function() {
                    ...
                    require(
                        ...
                        function(ec) {
                            ...
                            var monarray = qwsys.changearray(scope.mon, "cus_alias", "acr_mon", "tot_amt");
                            option.legend.data = [];
                            option.xAxis = [];
                            option.series = [];
                            ...
                            optionb = {
                                ...
                                legend: {
                                    orient: 'vertical',
                                    x: 'left',
                                    data: qwsys.getarraycol(scope.model.content, "cus_alias")
                                },
                                toolbox: {
                                    show: true,
                                    feature: {
                                ...
                                series: [{
                                    ...
                                    radius: '55%',
                                    center: ['50%', '60%'],
                                    data: qwsys.getarraycolval(scope.model.content, "cus_alias", "tot_amt")
                                }]
                            };
