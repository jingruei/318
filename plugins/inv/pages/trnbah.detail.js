define(function() {
    angular.module('app').controller('inv.trnbah.detail',
                        ...
                        },
                        {
                            ...
                            action: {
                                add: {
                                    ...
                                    click: function() {
                                        var item = {
                                            ware_nbro: scope.model.ware_nbro,
                                            ware_nbri: scope.model.ware_nbri,
                                            isdel: false
                                        }
                                ...
                                "unit": {
                                    ...
                                    onchange: function(item) {
                                        ...
                                        qwsys.getohqty(item.ware_nbr, item.item_nbr, item.pro_nbr, item.unit).then(function(res) {
                                            item.be_qty = res.data.body;
                                            item.qty = item.af_qty - item.be_qty;
                                        })
                                    },
                                    width: 110
                                },
                ...
                del: function() {
                    dialog.confirm('确定删除当前数据?').then(function() {
                        scope.promise = utils.ajax({
                            ...
                            mockUrl: "plugins/data/trnbah.detail.json"
                        }).then(function(res) {
                            toastr.info("数据删除成功!!!");
                            scope.uid = "";
                            scope.action.add();
